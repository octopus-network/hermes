...
//     let channel_id = ibc::ics24_host::identifier::ChannelId::from_str("channel-1").unwrap();
...
//     let channel_end = ibc::ics04_channel::channel::ChannelEnd::decode_vec(&*data).unwrap();
