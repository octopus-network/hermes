...
impl AnyClientState {
    ...
    pub fn refresh_period(&self) -> Option<Duration> {
        match self {
            ...
            AnyClientState::Grandpa(tm_state) => tm_state.refresh_time(),
    ...
    pub fn expired(&self, elapsed_since_latest: Duration) -> bool {
        match self {
            ...
            AnyClientState::Grandpa(tm_state) => tm_state.expired(elapsed_since_latest),
    ...
    fn try_from(raw: Any) -> Result<Self, Self::Error> {
        match raw.type_url.as_str() {
            ...
            GRANDPA_CLIENT_STATE_TYPE_URL => Ok(AnyClientState::Grandpa(
                crate::clients::ics10_grandpa::client_state::ClientState::decode_vec(&raw.value)
                    .map_err(Error::decode_raw_client_state)?,
            )),
    ...
    fn upgrade(
        ...
        match self {
            AnyClientState::Tendermint(tm_state) => tm_state
                ...
                .wrap_any(),
            AnyClientState::Grandpa(gp_state) => todo!(),
