...
pub fn verify_proofs<HostFunctions: HostFunctionsProvider + 'static>(
...
pub fn verify_connection_proof<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ConnectionReader,
    height: Height,
    connection_end: &ConnectionEnd,
    expected_conn: &ConnectionEnd,
...
/// `proof` is correct.
pub fn verify_client_proof<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ConnectionReader,
    height: Height,
    connection_end: &ConnectionEnd,
...
pub fn verify_consensus_proof<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ConnectionReader,
    height: Height,
    connection_end: &ConnectionEnd,
