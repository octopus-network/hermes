...
pub fn verify_channel_proofs<HostFunctions: HostFunctionsProvider + 'static>(
...
pub fn verify_packet_recv_proofs<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ChannelReader,
    height: Height,
    packet: &Packet,
    connection_end: &ConnectionEnd,
...
pub fn verify_packet_acknowledgement_proofs<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ChannelReader,
    height: Height,
    packet: &Packet,
...
pub fn verify_next_sequence_recv<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ChannelReader,
    height: Height,
    connection_end: &ConnectionEnd,
    packet: Packet,
...
pub fn verify_packet_receipt_absence<HostFunctions: HostFunctionsProvider + 'static>(
    ctx: &dyn ChannelReader,
    height: Height,
    connection_end: &ConnectionEnd,
    packet: Packet,
