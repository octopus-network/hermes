...
pub(crate) fn process(
    ...
    tracing::trace!(target:"ibc-rs","[chan_open_confirm] begin to process the chan_open_confirm msg : {:?}",msg);
    ...
    tracing::trace!(target:"ibc-rs","[chan_open_confirm] process output : {:?}",output);
