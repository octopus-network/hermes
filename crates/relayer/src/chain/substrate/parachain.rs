...
mod subxt_ibc_event {
    ...
    use super::parachain_node::runtime_types::ibc::core::ics02_client::client_type::ClientType as SubxtClientType;
    use super::parachain_node::runtime_types::ibc::core::ics02_client::height::Height as SubxtHeight;
    use super::parachain_node::runtime_types::ibc::core::ics03_connection::connection::{
        sealed::ConnectionEnd as SubxtConnectionEnd, Counterparty as SubxtConnectionCounterparty,
        State as SubxtConnectionState,
    };
    use super::parachain_node::runtime_types::ibc::core::ics03_connection::version::Version as SubxtConnectionVersion;
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::channel::{
    ...
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::commitment::{
        AcknowledgementCommitment as SubxtAcknowledgementCommitment,
        PacketCommitment as SubxtPacketCommitment,
    };
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::msgs::acknowledgement::Acknowledgement as SubxtAcknowledgement;
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::packet::{
        Receipt as SubxtReceipt, Sequence as SubxtSequence,
    };
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::timeout::TimeoutHeight as SubxtTimeoutHeight;
    use super::parachain_node::runtime_types::ibc::core::ics04_channel::version::Version as SubxtChannelVersion;
    use super::parachain_node::runtime_types::ibc::core::ics23_commitment::commitment::CommitmentPrefix as SubxtCommitmentPrefix;
    use super::parachain_node::runtime_types::ibc::core::ics24_host::identifier::{
        ChannelId as SubxtChannelId, ClientId as SubxtClientId, ConnectionId as SubxtConnectionId,
        PortId as SubxtPortId,
    };
    use super::parachain_node::runtime_types::ibc::core::ics26_routing::context::ModuleId as SubxtModuleId;
    use super::parachain_node::runtime_types::ibc::core::{
        ics02_client::events::{
    ...
    use super::parachain_node::runtime_types::ibc::events::{
        ModuleEvent as SubxtModuleEvent, ModuleEventAttribute as SubxtModuleEventAttribute,
    };
    use super::parachain_node::runtime_types::ibc::timestamp::Timestamp as SubxtTimestamp;
    use super::parachain_node::runtime_types::{self, ibc::events::IbcEvent as SubxtIbcEvent};
