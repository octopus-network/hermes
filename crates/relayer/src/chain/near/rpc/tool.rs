    ...
    let event = match ibc_event {
        IbcEvent::CreateClient(create_client) => {
            ...
            HermesIbcEvent::CreateClient(
                ibc_relayer_types::core::ics02_client::events::CreateClient::from(Attributes {
                    client_id: ClientId::from_str(create_client.client_id().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
        ...
        IbcEvent::UpdateClient(update_client) => {
            ...
            HermesIbcEvent::UpdateClient(
                ibc_relayer_types::core::ics02_client::events::UpdateClient::from(Attributes {
                    client_id: ClientId::from_str(update_client.client_id().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::UpgradeClient(upgrade_client) => {
            ...
            HermesIbcEvent::UpgradeClient(
                ibc_relayer_types::core::ics02_client::events::UpgradeClient::from(Attributes {
                    client_id: ClientId::from_str(upgrade_client.client_id().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::OpenInitChannel(open_init_channel) => HermesIbcEvent::OpenInitChannel(
            ibc_relayer_types::core::ics04_channel::events::OpenInit {
                port_id: PortId::from_str(open_init_channel.port_id_on_a().as_str()).map_err(
                    |e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                ...
                channel_id: Some(
                    ChannelId::from_str(open_init_channel.chan_id_on_a().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::OpenTryChannel(open_try_channel) => HermesIbcEvent::OpenTryChannel(
            ibc_relayer_types::core::ics04_channel::events::OpenTry {
                port_id: PortId::from_str(open_try_channel.port_id_on_b().as_str()).map_err(
                    |e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                ...
                channel_id: Some(
                    ChannelId::from_str(open_try_channel.chan_id_on_b().as_str()).map_err(|e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                        )
                ...
                counterparty_channel_id: Some(
                    ChannelId::from_str(open_try_channel.chan_id_on_a().as_str()).map_err(|e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                        )
        ...
        IbcEvent::OpenAckChannel(open_ack_channel) => HermesIbcEvent::OpenAckChannel(
            ibc_relayer_types::core::ics04_channel::events::OpenAck {
                port_id: PortId::from_str(open_ack_channel.port_id_on_a().as_str()).map_err(
                    |e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                ...
                channel_id: Some(
                    ChannelId::from_str(open_ack_channel.chan_id_on_a().as_str()).map_err(|e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                        )
                ...
                counterparty_channel_id: Some(
                    ChannelId::from_str(open_ack_channel.chan_id_on_b().as_str()).map_err(|e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                        )
        ...
        IbcEvent::OpenConfirmChannel(open_confirm_channel) => HermesIbcEvent::OpenConfirmChannel(
            ibc_relayer_types::core::ics04_channel::events::OpenConfirm {
                port_id: PortId::from_str(open_confirm_channel.port_id_on_b().as_str()).map_err(
                    |e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                ...
                channel_id: Some(
                    ChannelId::from_str(open_confirm_channel.chan_id_on_b().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
                ...
                counterparty_channel_id: Some(
                    ChannelId::from_str(open_confirm_channel.chan_id_on_a().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::CloseInitChannel(close_init_channel) => HermesIbcEvent::CloseInitChannel(
            ibc_relayer_types::core::ics04_channel::events::CloseInit {
                port_id: PortId::from_str(close_init_channel.port_id_on_a().as_str()).map_err(
                    |e| {
                        NearError::custom_error(
                            e.to_string(),
                            std::panic::Location::caller().to_string(),
                ...
                counterparty_channel_id: Some(
                    ChannelId::from_str(close_init_channel.chan_id_on_b().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::SendPacket(send_packet) => {
            HermesIbcEvent::SendPacket(ibc_relayer_types::core::ics04_channel::events::SendPacket {
                packet: Packet {
                    ...
                    source_port: PortId::from_str(send_packet.port_id_on_a().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::ReceivePacket(receive_packet) => HermesIbcEvent::ReceivePacket(
            ibc_relayer_types::core::ics04_channel::events::ReceivePacket {
                packet: Packet {
                    ...
                    source_port: PortId::from_str(receive_packet.port_id_on_b().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
        ...
        IbcEvent::TimeoutPacket(timeout_packet) => HermesIbcEvent::TimeoutPacket(
            ibc_relayer_types::core::ics04_channel::events::TimeoutPacket {
                packet: Packet {
                    ...
                    source_port: PortId::from_str(timeout_packet.port_id_on_a().as_str()).map_err(
                        |e| {
                            NearError::custom_error(
                                e.to_string(),
                                std::panic::Location::caller().to_string(),
...
fn convert_timeout_height(
    ...
    match timeout_height {
        ...
        ibc::core::ics04_channel::timeout::TimeoutHeight::At(height) => Ok(TimeoutHeight::At(
            Height::new(height.revision_number(), height.revision_height()).map_err(|e| {
