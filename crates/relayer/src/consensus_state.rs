...
impl AnyConsensusState {
    pub fn timestamp(&self) -> Timestamp {
        match self {
            ...
            Self::Grandpa(cs_state) => cs_state.timestamp.into(),
    ...
    pub fn client_type(&self) -> ClientType {
        match self {
            Self::Tendermint(_cs) => ClientType::Tendermint,
            Self::Grandpa(_cs) => ClientType::Grandpa,

            #[cfg(test)]
            Self::Mock(_cs) => ClientType::Mock,
        }
    }
}
