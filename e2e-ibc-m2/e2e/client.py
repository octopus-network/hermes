...
def create_update_query_client(c: Config, dst: ChainId,
    ...
    client_1 = create_client(c, dst, src)
    split()
    client_2 = create_client(c, src, dst)
    split()    # sleep(20)
    sleep(10)

    update_client(c, dst, client_1.client_id)
    split()
    update_client(c, src, client_2.client_id)
    split()
    query_client_state(c, dst, client_1.client_id)
    split()
    query_client_state(c, src, client_2.client_id)
    split()

    return client_1.client_id, client_2.client_id
